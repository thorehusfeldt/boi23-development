...
Group & Points & Constraints \\\hline
  $1$ & $8$  & $p\leq 10^6$ and there exists an optimal strategy, where Tycho does not wait at any position \emph{after} leaving position 0. (But he might need to wait at position 0!) \\ % constraint:nowait
