...
The situation is made even worse by radiation from a nearby pulsar, which adds $d$ additional units of damage every $m$ seconds.
...
Group & Points & Constraints \\\hline
  $1$ & $8$  & $p\leq 10^6$ and there exists an optimal strategy, where Tycho does not wait at any position \emph{after} leaving position~$0$. (But it might need to wait at position~$0$!) \\ % constraint:nowait
