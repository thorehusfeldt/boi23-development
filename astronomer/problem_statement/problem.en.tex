...
Building a telescope with radius~$r$ costs $t\cdot r$~kroner. The radius can be any nonnegative real number.
...
How much does it cost to build and move a telescope that allows at least $k$~stars to be observed at once?
...
Then follow $n$ lines, where the $i$th line contains the integer coordinates $x_i$ and $y_i$ of the $i$th star. The coordinates of all stars are unique.
